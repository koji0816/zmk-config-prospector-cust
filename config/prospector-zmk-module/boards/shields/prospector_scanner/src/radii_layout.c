...
static void create_left_panel(lv_obj_t *parent) {
    ...
    /* Center panel (was left panel): 180x180 circle in the middle */
    left_panel = lv_obj_create(parent);
    lv_obj_set_size(left_panel, 180, 180);
    lv_obj_align(left_panel, LV_ALIGN_CENTER, 0, 0);
    ...
    lv_obj_set_flex_align(layer_container, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
    lv_obj_set_style_pad_row(layer_container, 8, LV_PART_MAIN);
